...
local fonts = {
    ...
    "CommitMono Nerd Font Mono,Sarasa Mono SC:h12",
    ...
    "FiraCode Nerd Font Mono,Sarasa Mono SC:h12",
    ...
    "JetBrainsMono Nerd Font Mono,Sarasa Mono SC:h12",
    "Maple Mono NF CN:h12",
    "MesloLGMDZ Nerd Font Mono,Sarasa Mono SC:h12",
    ...
    "RobotoMono Nerd Font Mono,Sarasa Mono SC:h12",
    "SauceCodePro Nerd Font Mono,Sarasa Mono SC:h12",
    "UbuntuMono Nerd Font Mono,LXGW WenKai Mono:h13",
    "VictorMono Nerd Font Mono,LXGW WenKai Mono:h12",
    "Sarasa Mono SC,Symbols Nerd Font Mono:h12",
}
